...
(function (Buffer){
"use strict";require("isomorphic-fetch");var defaults=require("101/defaults"),crypto=require("crypto"),createPad=require("./lib/pad");module.exports=function(e,r,t,n,a){if(!e){var i=new Error("graphqlUrl missing");throw i.code="EURLMISSING",i}n||(n="aes256");var o=createPad(a||1024),c=function(e){e=o(e);var r=crypto.createCipher(n,t);return Buffer.concat([r.update(e),r.final()]).toString("base64")},u=function(e){var r=crypto.createDecipher(n,t);return Buffer.concat([r.update(e,"base64"),r.final()]).toString("utf8")};return function(t,a,i){if(!t){var o=new Error("query is required");return o.code="EQUERYMISSING",Promise.reject(o)}i=i||{},defaults(i,{method:"POST",headers:new Headers});var s=i.headers;return s.set("x-cipher",n),s.set("x-key-id",r),s.set("content-transfer-encoding","base64"),s.get("content-type")||s.append("content-type","application/json"),i.body=c(JSON.stringify({t:Date.now(),payload:{query:t,variables:a||{}}})),fetch(e,i).then(function(e){return u(e.text())}).then(function(e){return JSON.parse(e).payload})}};
